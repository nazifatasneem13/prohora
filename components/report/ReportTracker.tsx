  ...
  return (
    <div className="w-full dark:bg-black">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="mt-6 bg-gradient-to-b from-black to-black/80 dark:from-white dark:to-white/80 bg-clip-text text-4xl font-bold tracking-tight text-transparent  text-black dark:text-white">
          Track Your Report
          <span className="block bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">
            Stay Informed
          </span>
        </h1>
        <p className="mt-4 text-800 dark:text-zinc-400 max-w-xl mx-auto">
      ...
      <div className="flex justify-center ">
        ...
        >
          {/* Form Section */}
          <div
            className={`bg-stone-50 shadow-lg dark:bg-gray-800/50  backdrop-blur-xl rounded-2xl border 
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="relative">
                <label
                  htmlFor="reportId"
                  className="block text-sm font-medium mb-2 text-zinc-800 dark:text-zinc-400"
                >
                  Report ID
                </label>
                <input
                  ...
                  className="w-full px-4 py-3 bg-white shadow-md border-collapse dark:bg-black/50 border border-white/5 rounded-xl
          ...
          >
            {reportDetails && (
              <div className="rounded-xl border border-white/5  bg-white/30  dark:bg-black/30 backdrop-blur-xl p-6 h-full">
                ...
                <div className="grid gap-4">
                  ...
                  <div className="p-3 rounded-lg bg-white/5 space-y-1.5">
                    <span className="text-zinc-800 dark:text-zinc-400 text-sm">
                      Title
                    </span>
                    <span className="text-black dark:text-white block font-medium">
                      {reportDetails.title}
                    </span>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-white/5 space-y-1.5">
                    <span className="text-zinc-800 dark:text-zinc-400 hover:text-black text-sm">
                      Description
                    </span>
...
function getStatusColor(status: string): string {
  ...
  return statusColors[status.toLowerCase()] || "text-black dark:text-white";
}
