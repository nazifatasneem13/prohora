...
export function ReportStatus({ report }: ReportStatusProps) {
  ...
  return (
    <div className="rounded-xl bg-stone-200/50  dark:bg-zinc-900/50  border border-zinc-800/50 p-6 space-y-6">
      {/* Status Header */}
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <p className="text-sm text-zinc-800 dark:text-zinc-400">Report ID</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          <p className="text-sm text-zinc-800 dark:text-zinc-400 hover:text-black">
            Priority Level
          </p>
          <p className="text-sm text-black dark:text-white mt-1">
