        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-24 grid gap-12">
            {[
              ...
              <div
                key={i}
                className="group relative overflow-hidden rounded-2xl bg-stone-50 dark:bg-zinc-900 p-8 transition-all hover:bg-stone-1000/60 dark:hover:bg-gray-1000/60 shadow-lg"
              >
                ...
                <div className="relative flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-base leading-relaxed text-muted text-zinc-600 dark:text-zinc-400">
                      {step.description}
                    </p>
                  </div>
                </div>
          ...
          {/* Security Features */}
          <div className="mt-24 rounded-2xl bg-stone-50 dark:bg-zinc-900 p-8 shadow-lg transition-all hover:bg-stone-1000/60 dark:hover:bg-gray-1000/60">
            <h2 className="text-2xl font-bold text-foreground dark:text-white text-center mb-8">
              Security Measures
            </h2>
            <div className="grid gap-6 sm:grid-cols-3">
              {[
                ...
                <div key={i} className="text-center p-6">
                  ...
                  <p className="text-sm text-muted text-zinc-600 dark:text-zinc-400">
                    {feature.description}
                  </p>
                </div>
              ))}
